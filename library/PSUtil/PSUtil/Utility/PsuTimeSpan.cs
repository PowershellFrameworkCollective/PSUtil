...
{
    /// <summary>
    /// Wrapper class for a regular timespan. Copied from dbatools
    /// </summary>
    public class PsuTimeSpan : IComparable, IComparable<TimeSpan>, IComparable<PsuTimeSpan>, IEquatable<TimeSpan>
    {
        ...
        public PsuTimeSpan(TimeSpan Timespan)
        {
            _timespan = Timespan;
        }
        ...
        public PsuTimeSpan(string Timespan)
        {
        ...
        public PsuTimeSpan(int hours, int minutes, int seconds)
        {
        ...
        /// <param name="minutes"></param>
        /// <param name="seconds"></param>
        public PsuTimeSpan(int days, int hours, int minutes, int seconds)
        {
        ...
        public PsuTimeSpan(int days, int hours, int minutes, int seconds, int milliseconds)
        {
        ...
        internal static TimeSpan ParseTimeSpan(string Value)
        {
            ...
            foreach (string element in tempValue.Split(' '))
            {
                ...
                else if (PSFramework.Utility.UtilityHost.IsLike(element, "*ms") && Regex.IsMatch(element, @"^\d+ms$", RegexOptions.IgnoreCase))
                ...
                else if (PSFramework.Utility.UtilityHost.IsLike(element, "*s") && Regex.IsMatch(element, @"^\d+s$", RegexOptions.IgnoreCase))
                    timeResult = timeResult.Add(new TimeSpan(0, 0, Int32.Parse(Regex.Match(element, @"^(\d+)s$", RegexOptions.IgnoreCase).Groups[1].Value)));
                else if (PSFramework.Utility.UtilityHost.IsLike(element, "*m") && Regex.IsMatch(element, @"^\d+m$", RegexOptions.IgnoreCase))
                    timeResult = timeResult.Add(new TimeSpan(0, Int32.Parse(Regex.Match(element, @"^(\d+)m$", RegexOptions.IgnoreCase).Groups[1].Value), 0));
                else if (PSFramework.Utility.UtilityHost.IsLike(element, "*h") && Regex.IsMatch(element, @"^\d+h$", RegexOptions.IgnoreCase))
                    timeResult = timeResult.Add(new TimeSpan(Int32.Parse(Regex.Match(element, @"^(\d+)h$", RegexOptions.IgnoreCase).Groups[1].Value), 0, 0));
                else if (PSFramework.Utility.UtilityHost.IsLike(element, "*d") && Regex.IsMatch(element, @"^\d+d$", RegexOptions.IgnoreCase))
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public int CompareTo(PsuTimeSpan value)
        {
        ...
        public static implicit operator TimeSpan(PsuTimeSpan Base)
        {
        ...
        public static implicit operator PsuTimeSpan(TimeSpan Base)
        {
            return new PsuTimeSpan(Base);
        }
